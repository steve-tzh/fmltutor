...
public class BlockMetalFurnace extends Block
{
    ...
    public static final PropertyEnum MATERIAL = PropertyEnum.create("material", EnumMaterial.class);
    ...
    {
        return ((EnumMaterial) state.getValue(MATERIAL)).ordinal() << 3;
    }
    ...
    public int getMetaFromState(IBlockState state)
    {
        ...
        int material = ((EnumMaterial) state.getValue(MATERIAL)).ordinal() << 3;
